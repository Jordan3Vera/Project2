 ...
 * ESPECIFICADAS COMO CARGA PERESZOSA
 *
 * LA IDEA ES QUE A TRAVÉS DE UN EVENTO EN EL DOM (CLICK, HOVER, LOGN PRESS..)
 * SE INICIE UN MÓDULO QUE PREDECIMOS QUE VA A NECESITAR:
 *
 * CON ESTO SE PUEDE CONSEGUIR UNA MEJOR EXPERIENCIA DE USAURIO, AL EVITAR QUE LA APLICACIÓN SE QUEDE CARGANDO
 * CUANDO TENGA QUE DE MANERA PEREZOSA CARGAR UN MÓDULO DE RUTAS NUEVO.
 *
 * ?POR EJEMPLO:
 * * SI UN USUARIO PASA EL CURSO POR UN ELEMENTO DEL MENÚ AL QUE CLARAMENTE VA A CARGAR
 * * PRECARGAMOS EL MÓDULO EN EL SEGUNDO PLANO, PARA QUE LA NAVEGACIÓN SEA MÁS FLUIDA Y REDUCIR TIEMPOS DE CARGA.
 */
